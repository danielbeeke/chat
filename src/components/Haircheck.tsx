      ...
      <div>
        <DeviceSelector
          ...
          render={({
            ...
            if (hasDevice === false) {
              return <Error>Geen camera's gevonden.</Error>;
            }

            if (permissionDenied === true) {
              return <Error>Camera toegang geweigerd.</Error>;
            }

            if (requestingCapture === true) {
              return <Info>Camera toegang aanvragen</Info>;
            }
            ...
            if (requestPermissions) {
              return (
                <PermissionButton onClick={requestPermissions}>
                  <VideocamIcon />
                  <span>Camera toegang verlenen</span>
                </PermissionButton>
              );
            }
      ...
      <div>
        <DeviceSelector
          ...
          render={({
            ...
            if (hasDevice === false) {
              return <Error>Geen microfoon gevonden.</Error>;
            }

            if (permissionDenied === true) {
              return <Error>Microfoon toegang geweigerd.</Error>;
            }

            if (requestingCapture === true) {
              return <Info>Microfoon toegang aanvragen</Info>;
            }
            ...
            if (requestPermissions) {
              return (
                <PermissionButton onClick={requestPermissions}>
                  <MicIcon />
                  <span>Microfoon toegang verlenen</span>
                </PermissionButton>
              );
            }
              ...
              <>
                ...
                <InputChecker
                  ...
                  render={({ detected, lost }) => {
                    ...
                    if (!detected) {
                      return (
                        <Info>Geen geluid gedetecteerd van je microfoon.</Info>
                      );
                    }
